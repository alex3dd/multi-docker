docker build -t alex3dd/multi-client:latest -t alex3dd/multi-client:$SHA -f ./client/Dockerfile ./client
docker build -t alex3dd/multi-server:latest -t alex3dd/multi-server:$SHA -f ./server/Dockerfile ./server
docker build -t alex3dd/multi-worker:latest -t alex3dd/multi-worker:$SHA -f ./worker/Dockerfile ./worker
